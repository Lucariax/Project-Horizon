...
public final class GameGraphics implements ImageObserver {
    ...
    private static final String TITLE               = "JobSim";
    ...
    private static void checkAnimationSettings() {
        try {
            ...
            if (settingsFile.exists()) {
                ...
                input.close();
                System.out.println("***");
                System.out.println("*** GameGraphics saving animated GIF: " + 
    ...
    public static boolean mainIsActive() {
        ...
        for (int i = 0; i < threads.length; i++) {
            ...
            if (DEBUG) System.out.println("    GameGraphics.mainIsActive(): " + thread.getName() + ", priority=" + thread.getPriority() + ", alive=" + thread.isAlive() + ", stack=" + java.util.Arrays.toString(thread.getStackTrace()));
    ...
    public GameGraphics(int width, int height) {
        ...
        if (DEBUG) System.out.println("GameGraphics(w=" + width + ",h=" + height + ",anim=" + isAnimated() + ",graph=" + isGraphical() + ",save=" + shouldSave());
         ...
         // Transparent 16 x 16 pixel cursor image.
            ...
            try {
                Runtime.getRuntime().addShutdownHook(new Thread(new Runnable() {
                    ...
                    public void run() {
                        if (DEBUG) System.out.println("GameGraphics.run(): Running shutdown hook");
                        if (DEBUG) System.out.println("GameGraphics shutdown hook: instances=" + instances);
                        try {
                ...
                if (DEBUG) System.out.println("GameGraphics(): unable to add shutdown hook: " + e);
            }
        }
    }
    ...
    private BufferedImage getImage() {
        ...
        // if (DEBUG) System.out.println("GameGraphics getImage setting background to " + backgroundColor);
        g.setColor(backgroundColor);
     ...
     * extracted from this by calling GameGraphics.getRed, getGreen, and getBlue.
     * If nothing has been explicitly drawn on this particular pixel, the panel's
     * background color is returned.
     * See also: getPixel.
     */
    ...
    /**
     * Returns the colors of all pixels in this GameGraphics as a 2-D array
     * of Color objects.
     ...
     * the GameGraphics is run 'headless' without a GUI, often for scripting
...
*/
    ...
    public void saveAnimated(String filename) throws IOException {
        ...
        if (DEBUG) System.out.println("GameGraphics.saveAnimated(" + filename + ")");
    ...
    /**
     * Sets the colors of all pixels in this GameGraphics to the colors
    ...
    public void controls() {
    	JOptionPane.showMessageDialog(frame, "Controls\n\nMove the paddle by moving your mouse to deflect the ball, aiming to hit\nthe blocks to get the most points. If the ball falls below the screen,\nthen you lose one life. Once you've lost your last life, It's game over.\n\nEsc - Pause the game");
    }
    
    public void developer() {
    	JOptionPane.showMessageDialog(frame, "Programmed and Developed by Michael Nersinger, class of 2019.");
    }
    ...
    private void setupMenuBar() {
        ...
        developer.addActionListener(actionListener);
